...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: FAILED before fix: expected Bob first, but got Sue because the queue used LIFO order.
    // PASSED after the queue implementation was fixed.
    ...
    // Defect(s) Found: FAILED before fix: expected Tim first, but got Sue because the queue used LIFO order.
    // PASSED after the queue implementation was fixed.
    ...
    // Defect(s) Found: PASSED before and after the fix; no defect was found in the empty-queue behavior.
